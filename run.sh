...
#  docker rm skale_schain_skaled
  docker run --name skale_schain_skaled -v `pwd`/${_DATA_DIR}:/data_dir ${_args_arr} -e DATA_DIR=/data_dir -e minBlockIntervalMs=5000 --stop-timeout 40 -i -t ${_SKALED_IMAGE} ${_options}
